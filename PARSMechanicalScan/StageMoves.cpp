...
void XDIR(int in)
{
	...
	DAQmxCreateDOChan(XDir, "Dev1/port0/line3", "XDir", DAQmx_Val_ChanForAllLines); // Xdirection
...
void YDIR(int in)
{
	...
	DAQmxCreateDOChan(YDir, "Dev1/port0/line2", "YDir", DAQmx_Val_ChanForAllLines); // Ydirection
...
void XON(int in)
{
	...
	DAQmxCreateDOChan(XOn, "Dev1/port0/line5", "XON", DAQmx_Val_ChanForAllLines); // Xon
...
void YON(int in)
{
	...
	DAQmxCreateDOChan(YOn, "Dev1/port0/line4", "YON", DAQmx_Val_ChanForAllLines); // Yon	
